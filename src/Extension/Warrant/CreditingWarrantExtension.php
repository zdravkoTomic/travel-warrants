...
class CreditingWarrantExtension implements QueryCollectionExtensionInterface, QueryItemExtensionInterface
{
    ...
    private function addWhere(QueryBuilder $queryBuilder, string $resourceClass): void
    {
        ...
        if (Warrant::class !== $resourceClass
            || $routeName !== 'get_crediting_warrants'
        ...
        foreach ($employeeRoles as $employeeRole) {
            if ($employeeRole->getRole()->getName() === Role::ROLE_PROCURATOR) {
